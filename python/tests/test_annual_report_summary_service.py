...
import app.services.annual_report_summary_service as summary_service


def test_summarize_annual_report_success(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(summary_service, "download_shareholders_annual_report", fake_download)
    ...
    result = summary_service.summarize_annual_report(
        ticker="2330",
        report_year=2023,
        report_type="F04",
        force=False,
