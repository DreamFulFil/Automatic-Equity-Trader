...
class ArbitragePairsTradingStrategyTest {

    private ArbitragePairsTradingStrategy strategy;
    private Portfolio portfolio;

    @BeforeEach
    void setUp() {
        strategy = new ArbitragePairsTradingStrategy();
    ...
    @Test
    void execute_withValidData_returnsNeutral() {
        ...
        assertEquals(TradeSignal.SignalDirection.NEUTRAL, signal.getDirection());
        assertEquals("No arbitrage opportunities", signal.getReason());
    }

    @Test
    void getName_returnsCorrectName() {
        assertEquals("Arbitrage / Pairs Trading", strategy.getName());
    }
