...
import tw.gc.auto.equity.trader.strategy.TradeSignal.SignalDirection;
...
class DCAStrategyTest {
    ...
    void testTargetPositionReached_ReturnsNeutral() {
        ...
        portfolio.getPositions().put("AUTO_EQUITY_TRADER", 100);
    ...
    void testTargetPositionExceeded_ReturnsNeutral() {
        ...
        portfolio.getPositions().put("AUTO_EQUITY_TRADER", 150);
    ...
    void testReset_ClearsState() {
        ...
        assertNotNull(strategy.getLastPurchaseTime("AUTO_EQUITY_TRADER"));
        
        // Reset
        strategy.reset();
        
        // Verify state cleared
        assertNull(strategy.getLastPurchaseTime("AUTO_EQUITY_TRADER"));
    ...
    void testPartialPosition_StillGeneratesBuySignal() {
        ...
        portfolio.getPositions().put("AUTO_EQUITY_TRADER", 50);
